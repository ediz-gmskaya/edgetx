...
/*
* Notes to whoever wants to check my translation for legitimacy/errors and whoever wants to improve it
- I will try to put as much comments as possible
- I am not sure if translating "Radio" to "Kumanda" was the right call
- using "" all the time would take a lot of time so I decieded not to use it that much
...
*/
// Main menu
#define TR_QM_MANAGE_MODELS             "Modelleri\nYönet" // "Manage\nModels" to "Modelleri\nYönet"
